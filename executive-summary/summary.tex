...
\newcommand{\summarywordcount}{987}
...
% automatic mark loss), so it is shown here. The value is the official texcount:
% `texcount -merge summary.tex` from executive-summary/ reports "Words in text: 975"
% (headers add 10; the thesis-cover convention decides whether those 10 are included
% — set both covers by the same rule at the final build). Re-run texcount if the
