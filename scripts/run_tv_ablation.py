...
This Stage B-TV run is done and its arms are CUT from the real-data path
(scope verdict). The verdict it produced — exact TV collapses
...
is reported in notebooks/03. Re-runnable on
the toy only.
